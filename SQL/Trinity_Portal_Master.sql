...
(15, @GOSSIP_MENU, 1, 6, 469, "Sturmwind"),
(15, @GOSSIP_MENU+5, 2, 6, 469, "Dun Morogh"),
(15, @GOSSIP_MENU+5, 3, 6, 67, "Tirisfall"),
(15, @GOSSIP_MENU+5, 4, 6, 67, "Geisterlande"),
(15, @GOSSIP_MENU+5, 5, 6, 469, "Loch Modan"),
(15, @GOSSIP_MENU+5, 6, 6, 67, "Silberwald"),
(15, @GOSSIP_MENU+5, 7, 6, 469, "Westfall"),
(15, @GOSSIP_MENU+5, 8, 6, 469, "Rotkammgebirge"),
(15, @GOSSIP_MENU+5, 9, 6, 469, "Dämmerwald"),
(15, @GOSSIP_MENU+5, 11, 6, 469, "Sumpfland"),
(15, @GOSSIP_MENU+6, 0, 6, 469, "Azurmythos Insel"),
(15, @GOSSIP_MENU+6, 1, 6, 469, "Teldrassil"),
(15, @GOSSIP_MENU+6, 2, 6, 67, "Durotar"),
(15, @GOSSIP_MENU+6, 3, 6, 67, "Mulgore"),
(15, @GOSSIP_MENU+6, 4, 6, 469, "Blutmythos Insel"),
(15, @GOSSIP_MENU+6, 5, 6, 469, "Dunkelküste"),
(15, @GOSSIP_MENU+6, 6, 6, 67, "Brachland"),
(15, @GOSSIP_MENU+5, 1, 6, 67, "Immersangwald"),
(15, @GOSSIP_MENU+5, 0, 6, 469, "Wald von Elwynn"),
(15, @GOSSIP_MENU+4, 22, 6, 67, "Zul'Aman"),
(15, @GOSSIP_MENU, 2, 6, 67, "Orgrimmar"),
(15, @GOSSIP_MENU, 3, 6, 469, "Darnassus"),
(15, @GOSSIP_MENU, 4, 6, 469, "Eisenschmiede"),
(15, @GOSSIP_MENU, 5, 6, 469, "Exodar"),
(15, @GOSSIP_MENU, 6, 6, 67, "Donnerfels"),
(15, @GOSSIP_MENU, 7, 6, 67, "Unterstadt"),
(15, @GOSSIP_MENU, 8, 6, 67, "Silbermond"),
(15, @GOSSIP_MENU+1, 0, 6, 469, "Gnomeregan"),
(15, @GOSSIP_MENU+1, 1, 6, 469, "Todesminen"),
(15, @GOSSIP_MENU+1, 2, 6, 469, "Das Verlies"),
(15, @GOSSIP_MENU+1, 3, 6, 67, "Der Flammenschlund"),
(15, @GOSSIP_MENU+1, 4, 6, 67, "Razorfener Hügel"),
(15, @GOSSIP_MENU+1, 5, 6, 67, "Kral von Razorfen"),
(15, @GOSSIP_MENU+1, 6, 6, 67, "Das Schalachrote Kloster"),
(15, @GOSSIP_MENU+1, 7, 6, 67, "Burg Schattenfang"),
(15, @GOSSIP_MENU+1, 8, 6, 67, "Hölen des Wehklagens"),
(15, @GOSSIP_MENU+6, 9, 6, 67, "Tausend Nadeln"),
(14, @GOSSIP_MENU, @TEXT_ID+1, 6, 469, "Für die Allianz"),
(14, @GOSSIP_MENU, @TEXT_ID, 6, 67, "Für die Horde");
...
(@GOSSIP_MENU, 1, 2, "Sturmwind", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist Du sicher das Du nach Sturmwind reisen willst?"),
(@GOSSIP_MENU, 2, 2, "Orgrimmar", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist Du sicher das Du nach Orgrimmar reisen willst?"),
(@GOSSIP_MENU, 3, 2, "Darnassus", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist Du sicher das Du nach Darnassus reisen willst?"),
(@GOSSIP_MENU, 4, 2, "Eisenschmiede", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist Du sicher das Du nach Eisenschmiede reisen willst?"),
(@GOSSIP_MENU, 5, 2, "Exodar", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist Du sicher das Du zur Exodar reisen willst?"),
(@GOSSIP_MENU, 6, 2, "Donnerfels", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist Du sicher das Du nach Donnerfels reisen willst?"),
(@GOSSIP_MENU, 7, 2, "Unterstadt", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist Du sicher das Du nach Unterstadt reisen willst?"),
(@GOSSIP_MENU, 8, 2, "Silbermond", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist Du sicher das Du nach Silbermond reisen willst?"),
(@GOSSIP_MENU, 9, 2, "Dalaran", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist Du sicher das Du nach Dalaran reisen willst?"),
(@GOSSIP_MENU, 10, 2, "Shattrath", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist Du sicher das Du nach Shattrath reisen willst?"),
(@GOSSIP_MENU, 11, 2, "Beutebucht", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist Du sicher das Du nach Beutebucht reisen willst?"),
(@GOSSIP_MENU, 12, 2, "Gurubashi Arena", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist Du sicher das Du zur Gurubashi Arena reisen willst?"),
(@GOSSIP_MENU, 13, 3, "Östliche Königreiche", 1, 1, @GOSSIP_MENU+5, 0, 0, 0, NULL),
(@GOSSIP_MENU, 14, 3, "Kalimdor", 1, 1, @GOSSIP_MENU+6, 0, 0, 0, NULL),
(@GOSSIP_MENU, 15, 3, "Scherbenwelt", 1, 1, @GOSSIP_MENU+7, 0, 0, 0, NULL),
(@GOSSIP_MENU, 16, 3, "Nordend", 1, 1, @GOSSIP_MENU+8, 0, 0, 0, NULL),
(@GOSSIP_MENU, 17, 9, "Dungeons: Klassisch", 1, 1, @GOSSIP_MENU+1, 0, 0, 0, NULL),
(@GOSSIP_MENU, 18, 9, "Dungeons: Burning Crusade", 1, 1, @GOSSIP_MENU+2, 0, 0, 0, NULL),
(@GOSSIP_MENU, 19, 9, "Dungeons: Lich King", 1, 1, @GOSSIP_MENU+3, 0, 0, 0, NULL),
(@GOSSIP_MENU, 20, 9, "Schlachtzüge", 1, 1, @GOSSIP_MENU+4, 0, 0, 0, NULL),
(@GOSSIP_MENU+1, 0, 2, "Gnomeregan", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Gnomeregan?"),
(@GOSSIP_MENU+1, 1, 2, "Die Todesminen", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to The Deadmines?"),
(@GOSSIP_MENU+1, 2, 2, "Das Verlies", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to The Stockade?"),
(@GOSSIP_MENU+1, 3, 2, "Der Flammenschlund", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Ragefire Chasm?"),
(@GOSSIP_MENU+1, 4, 2, "Hügel von Razorfen", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Razorfen Downs?"),
(@GOSSIP_MENU+1, 5, 2, "Kral von Razorfen", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Razorfen Kraul?"),
(@GOSSIP_MENU+1, 6, 2, "Schalachrotes Kloster", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Scarlet Monastery?"),
(@GOSSIP_MENU+1, 7, 2, "Burg Schattenfang", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Shadowfang Keep?"),
(@GOSSIP_MENU+1, 8, 2, "Hölen des Wehklagens", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Wailing Caverns?"),
(@GOSSIP_MENU+1, 9, 2, "Die Tiefschwarze Grotte", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Blackfathom Deeps?"),
(@GOSSIP_MENU+1, 10, 2, "Die Schwarzfelstiefen", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Blackrock Depths?"),
(@GOSSIP_MENU+1, 11, 2, "Die Schwarzfelsspitze", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Blackrock Spire?"),
(@GOSSIP_MENU+1, 12, 2, "Düsterbruch", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Dire Maul?"),
...
(@GOSSIP_MENU+1, 16, 2, "Der versunkene Tempel", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Sunken Temple?"),
...
(@GOSSIP_MENU+1, 19, 7, "Zurück", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+2, 0, 2, "Auchindoun", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Auchindoun?"),
(@GOSSIP_MENU+2, 1, 2, "Die Hölen der Zeit", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Caverns of Time?"),
(@GOSSIP_MENU+2, 2, 2, "Der Echsenkessel", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Coilfang Reservoir?"),
(@GOSSIP_MENU+2, 3, 2, "Die Höllenfeuerzitadelle", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Hellfire Citadel?"),
(@GOSSIP_MENU+2, 4, 2, "Die Terrasse des Magisters", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Magisters' Terrace?"),
(@GOSSIP_MENU+2, 5, 2, "Die Sturmfeste", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Tempest Keep?"),
(@GOSSIP_MENU+2, 6, 7, "Zurück", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+3, 0, 2, "Azjol-Nerub", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Azjol-Nerub?"),
(@GOSSIP_MENU+3, 1, 2, "Die Keulung von Stratholme", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to The Culling of Stratholme?"),
(@GOSSIP_MENU+3, 2, 2, "Die Prüfung des Champions", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Trial of the Champion?"),
(@GOSSIP_MENU+3, 3, 2, "Festung Drak'Tharon", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Drak'Tharon Keep?"),
(@GOSSIP_MENU+3, 4, 2, "Gundrak", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Gundrak?"),
(@GOSSIP_MENU+3, 5, 2, "Dungeons: Eiskrone", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Icecrown Citadel Dungeons?"),
(@GOSSIP_MENU+3, 6, 2, "Dungeons: Der Nexus", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to The Nexus Dungeons?"),
(@GOSSIP_MENU+3, 7, 2, "Die violette Festung", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to The Violet Hold?"),
(@GOSSIP_MENU+3, 8, 2, "Hallen des Blitzes", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Halls of Lightning?"),
(@GOSSIP_MENU+3, 9, 2, "Hallen aus Stein", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Halls of Stone?"),
(@GOSSIP_MENU+3, 10, 2, "Burg Utgarde", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Utgarde Keep?"),
(@GOSSIP_MENU+3, 11, 2, "Turm Utgarde", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Utgarde Pinnacle?"),
(@GOSSIP_MENU+3, 12, 7, "Zurück", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+4, 0, 2, "Der schwarze Tempel", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Black Temple?"),
(@GOSSIP_MENU+4, 1, 2, "Der Pechschwingenhort", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Blackwing Lair?"),
(@GOSSIP_MENU+4, 2, 2, "Hyjal: Der Gipfel", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Hyjal Summit?"),
(@GOSSIP_MENU+4, 3, 2, "Höhle des Schlangenschreins", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Serpentshrine Cavern?"),
(@GOSSIP_MENU+4, 4, 2, "Prüfung des Kreuzfahrers", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Trial of the Crusader?"),
(@GOSSIP_MENU+4, 5, 2, "Gruul's Hort", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Gruul's Lair?"),
(@GOSSIP_MENU+4, 6, 2, "Magtheridon's Hort", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Magtheridon's Lair?"),
(@GOSSIP_MENU+4, 7, 2, "Eiskronenzitadelle", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Icecrown Citadel?"),
(@GOSSIP_MENU+4, 8, 2, "Karazhan", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Karazhan?"),
(@GOSSIP_MENU+4, 9, 2, "Der geschmolzene Kern", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Molten Core?"),
(@GOSSIP_MENU+4, 10, 2, "Naxxramas", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Naxxramas?"),
(@GOSSIP_MENU+4, 11, 2, "Onyxia's Hort", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Onyxia's Lair?"),
(@GOSSIP_MENU+4, 12, 2, "Ruinen von Ahn'Qiraj", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Ruins of Ahn'Qiraj?"),
(@GOSSIP_MENU+4, 13, 2, "Sonnenbrunnen Plateau", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Sunwell Plateau?"),
(@GOSSIP_MENU+4, 14, 2, "Das Auge", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to The Eye?"),
(@GOSSIP_MENU+4, 15, 2, "Tempel von Ahn'Qiraj", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Temple of Ahn'Qiraj?"),
(@GOSSIP_MENU+4, 16, 2, "Das Auge der Ewigkeit", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to The Eye of Eternity?"),
(@GOSSIP_MENU+4, 17, 2, "Das Obsidian Sanktum", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to The Obsidian Sanctum?"),
(@GOSSIP_MENU+4, 18, 2, "Ulduar", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Ulduar?"),
(@GOSSIP_MENU+4, 19, 2, "Gewölbe von Archavon", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Vault of Archavon?"),
...
(@GOSSIP_MENU+4, 23, 7, "Zurück", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+5, 0, 2, "Wals von Elwynn", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Elwynn Forest?"),
(@GOSSIP_MENU+5, 1, 2, "Immersangwald", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Eversong Woods?"),
(@GOSSIP_MENU+5, 2, 2, "Dun Morogh", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Dun Morogh?"),
(@GOSSIP_MENU+5, 3, 2, "Tirisfall", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Tirisfal Glades?"),
(@GOSSIP_MENU+5, 4, 2, "Geisterlande", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Ghostlands?"),
(@GOSSIP_MENU+5, 5, 2, "Loch Modan", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Loch modan?"),
(@GOSSIP_MENU+5, 6, 2, "Silberwald", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Silverpine Forest?"),
(@GOSSIP_MENU+5, 7, 2, "Westfall", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Westfall?"),
(@GOSSIP_MENU+5, 8, 2, "Rotkammgebirge", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Redridge mountains?"),
(@GOSSIP_MENU+5, 9, 2, "Düsterwald", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Duskwood?"),
(@GOSSIP_MENU+5, 10, 2, "Vorgebirge von Hillsbrad", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Hillsbrad Foothills?"),
(@GOSSIP_MENU+5, 11, 2, "Sumpfland", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Wetlands?"),
(@GOSSIP_MENU+5, 12, 2, "Alteracgebirge", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Alterac Mountains?"),
(@GOSSIP_MENU+5, 13, 2, "Arathi Hochland", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Arathi Highlands?"),
(@GOSSIP_MENU+5, 14, 2, "Schlingendorntal", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Stranglethorn Vale?"),
(@GOSSIP_MENU+5, 15, 2, "Das Ödland", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Badlands?"),
(@GOSSIP_MENU+5, 16, 2, "Sümpfe des Elends", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Swamp of Sorrows?"),
(@GOSSIP_MENU+5, 17, 2, "Das Hinterland", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to The Hinterlands?"),
(@GOSSIP_MENU+5, 18, 2, "Die Sengende Schlucht", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Searing Gorge?"),
(@GOSSIP_MENU+5, 19, 2, "Die verwüsteten Lande", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to The Blasted Lands?"),
(@GOSSIP_MENU+5, 20, 2, "Die brennenden Steppen", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Burning Steppes?"),
(@GOSSIP_MENU+5, 21, 2, "Westliche Pestländer", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Western Plaguelands?"),
(@GOSSIP_MENU+5, 22, 2, "Östliche Pestländer", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Eastern Plaguelands?"),
(@GOSSIP_MENU+5, 23, 2, "Insel von Quel'Danas", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Isle of Quel'Danas?"),
(@GOSSIP_MENU+5, 24, 7, "Zurück", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+6, 0, 2, "Azurmythos Insel", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Azuremyst Isle?"),
...
(@GOSSIP_MENU+6, 4, 2, "Blutmythos Insel", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Bloodmyst Isle?"),
(@GOSSIP_MENU+6, 5, 2, "Dunkelküste", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Darkshore?"),
(@GOSSIP_MENU+6, 6, 2, "Das Brachland", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to The Barrens?"),
(@GOSSIP_MENU+6, 7, 2, "Steinkrallengebirge", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Stonetalon Mountains?"),
(@GOSSIP_MENU+6, 8, 2, "Der Eschenwald", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Ashenvale Forest?"),
(@GOSSIP_MENU+6, 9, 2, "Tausend Nadeln", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Thousand Needles?"),
(@GOSSIP_MENU+6, 10, 2, "Desolace", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Desolace?"),
(@GOSSIP_MENU+6, 11, 2, "Düstermarschen", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Dustwallow Marsh?"),
(@GOSSIP_MENU+6, 12, 2, "Feralas", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Feralas?"),
(@GOSSIP_MENU+6, 13, 2, "Die Wüste Tanaris", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Tanaris Desert?"),
(@GOSSIP_MENU+6, 14, 2, "Azshara", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Azshara?"),
(@GOSSIP_MENU+6, 15, 2, "Teufelswald", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Felwood?"),
(@GOSSIP_MENU+6, 16, 2, "Krater von Un'Goro", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Un'Goro Crater?"),
(@GOSSIP_MENU+6, 17, 2, "Silithus", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Silithus?"),
(@GOSSIP_MENU+6, 18, 2, "Winterquell", 1, 1, 0, 0, 0, 0, "Are you sure, that you want to go to Winterspring?"),
(@GOSSIP_MENU+6, 19, 7, "Zurück", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
